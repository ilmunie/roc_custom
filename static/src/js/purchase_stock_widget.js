odoo.define('roc_custom.QtyAtDateWidget', function (require) {
"use strict";
...
var QtyAtDateWidget = Widget.extend({
    ...
    async _openForecast(ev) {
        ...
        action.context = {
            ...
            purchase_line_to_match_id: this.data.id,
        };
    ...
    _getContent() {
        ...
        const $content = $(QWeb.render('roc_custom.QtyDetailPopOver', {
            data: this.data,
        }));
...
widget_registry.add('qty_at_date_widget_purchase', QtyAtDateWidget);
