# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'wizards/sale_alternative_product_assistant_views.xml',
        'wizards/sale_extra_product_selector_views.xml',
        'wizards/sale_extra_configurator_views.xml',
        ...
        'views/sale_order_template_tag_views.xml',
